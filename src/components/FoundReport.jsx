...
const FoundReport = () => {
    ...
    const handleAddingData=async({data})=>{
        try{
            setLoading(true)
            const res= await axios.post("https://goplanup.dishaayein.com/api/FoundPersons",data)
...
const handleChange = (e) => {
  ...
  if (name === "state") {
    ...
    // console.log("Random",Math.floor(Math.random() * (999999999 - 10000000) ) + 10000000)
...
const CITY=City.getCitiesOfState("IN",stateCode)
  ...
  return (
      ...
      <Form ref={formRef} onSubmit={(e) => handleSubmit(e)}>
        <h2 className="text-center py-4">Report Found Person</h2>

        {/* Found Person Details */}
        <Row>
          <Col md={1}></Col>
          <Col md={10} className="border-dark border-bottom border-2">
            <h4>Found Person Details</h4>
          </Col>
          <Col md={1}></Col>
        </Row>
   ...
   <input
        ...
        {/* <select 
            ...
            >
             ...
             {
                CITY.length>0?CITY.map((city)=><option value={city.name}>{city.name}</option>):<option selected disabled readonly>Please Select the State</option>
             }
            </select> */}
        ...
        <Row className="my-2">
          ...
          <Col md={5}>
            ...
            <input
              ...
              onChange={handleChange}
              type="date"
              className={getInputClasses('foundDateTime')}
              max={setMax()}
            />
        ...
        <Row className="my-2">
          ...
          <Col md={5}>
            ...
            <input
              name="foundStatus"
              value={formData.foundStatus}
              onChange={handleChange}
              type="text"
              placeholder='Example- Scratches on hand'
            />
...
{/*   // Contact Details
        <Row className="my-2">
          ...
          <Col md={5}>
            ...
            />
            {errors.contactNumber && <p className="error-text" style={{color: 'red', fontSize: '12px', margin: '2px 0'}}>{errors.contactNumber}</p>}
          </Col>
          <Col md={5}>
